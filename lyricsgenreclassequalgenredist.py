...
# Trains model on a random sample containing 900 songs per genre, weighting
# genres equally.
...
data_blues = pd.read_csv("tcc_ceds_music_blues.csv", sep=",").sample(n=900, random_state=366)
data_country = pd.read_csv("tcc_ceds_music_country.csv", sep=",").sample(n=900, random_state=366)
data_hiphop = pd.read_csv("tcc_ceds_music_hiphop.csv", sep=",").sample(n=900, random_state=366)
data_jazz = pd.read_csv("tcc_ceds_music_jazz.csv", sep=",").sample(n=900, random_state=366)
data_pop = pd.read_csv("tcc_ceds_music_pop.csv", sep=",").sample(n=900, random_state=366)
data_reggae = pd.read_csv("tcc_ceds_music_reggae.csv", sep=",").sample(n=900, random_state=366)
data_rock = pd.read_csv("tcc_ceds_music_rock.csv", sep=",").sample(n=900, random_state=366)
